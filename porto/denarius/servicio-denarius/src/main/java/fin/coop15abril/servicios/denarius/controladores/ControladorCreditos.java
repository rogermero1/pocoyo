...
public class ControladorCreditos {
	...
	@Operation(summary = "Api", description = "Consulta generica para Clientes Denarius")
	...
	public ResponseApi api(
		...
		try {
			...
			log.info("Procesando solicitud para método: " + request.getNombreMetodo() + " dataJson: " + request.getDataJson());

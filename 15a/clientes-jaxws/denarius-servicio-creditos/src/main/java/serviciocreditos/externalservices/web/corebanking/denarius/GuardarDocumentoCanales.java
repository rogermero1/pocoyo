 ...
 *       &lt;sequence&gt;
 *         &lt;element name="entrada" type="{http://schemas.datacontract.org/2004/07/DenariusCoreBanking.Web.ExternalServices.Creditos}MEDocumentoCredito" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class GuardarDocumentoCanales {
    ...
    protected JAXBElement<MEDocumentoCredito> entrada;
     ...
     *     
     */
    public JAXBElement<MEDocumentoCredito> getEntrada() {
        return entrada;
    }
     ...
     *     
     */
    public void setEntrada(JAXBElement<MEDocumentoCredito> value) {
        this.entrada = value;
    }

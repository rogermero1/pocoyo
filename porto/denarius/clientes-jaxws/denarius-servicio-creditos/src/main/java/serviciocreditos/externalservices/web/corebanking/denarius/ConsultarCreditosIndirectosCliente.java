 ...
 *       &lt;sequence&gt;
 *         &lt;element name="meConsultasCreditos" type="{http://schemas.datacontract.org/2004/07/DenariusCoreBanking.Web.ExternalServices}MEIdentificacionCliente" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "ConsultarCreditosIndirectosCliente")
public class ConsultarCreditosIndirectosCliente {
    ...
    protected JAXBElement<MEIdentificacionCliente> meConsultasCreditos;
     ...
     *     
     */
    public JAXBElement<MEIdentificacionCliente> getMeConsultasCreditos() {
     ...
     *     
     */
    public void setMeConsultasCreditos(JAXBElement<MEIdentificacionCliente> value) {

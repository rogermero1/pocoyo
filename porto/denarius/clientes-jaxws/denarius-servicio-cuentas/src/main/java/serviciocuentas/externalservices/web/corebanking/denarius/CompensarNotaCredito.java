 ...
 *       &lt;sequence&gt;
 *         &lt;element name="meCredito" type="{http://schemas.datacontract.org/2004/07/DenariusCoreBanking.Web.ExternalServices.Cuentas}MEReversoNdNc" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "CompensarNotaCredito")
public class CompensarNotaCredito {

    @XmlElementRef(name = "meCredito", namespace = "Denarius.CoreBanking.Web.ExternalServices", type = JAXBElement.class, required = false)
    protected JAXBElement<MEReversoNdNc> meCredito;
     ...
     *     
     */
    public JAXBElement<MEReversoNdNc> getMeCredito() {
        return meCredito;
    }
     ...
     *     
     */
    public void setMeCredito(JAXBElement<MEReversoNdNc> value) {

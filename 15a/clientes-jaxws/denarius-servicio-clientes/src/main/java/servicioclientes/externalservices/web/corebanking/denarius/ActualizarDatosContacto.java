 ...
 *       &lt;sequence&gt;
 *         &lt;element name="meEntrada" type="{http://schemas.datacontract.org/2004/07/DenariusCoreBanking.Web.ExternalServices.Clientes}MEDatosContacto" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "ActualizarDatosContacto")
public class ActualizarDatosContacto {
    ...
    protected JAXBElement<MEDatosContacto> meEntrada;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link MEDatosContacto }{@code >}
     *     
     */
    public JAXBElement<MEDatosContacto> getMeEntrada() {
        return meEntrada;
    }
     ...
     *     
     */
    public void setMeEntrada(JAXBElement<MEDatosContacto> value) {

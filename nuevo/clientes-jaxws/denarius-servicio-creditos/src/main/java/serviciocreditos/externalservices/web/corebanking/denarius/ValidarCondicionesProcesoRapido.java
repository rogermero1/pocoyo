 ...
 *       &lt;sequence&gt;
 *         &lt;element name="entrada" type="{http://schemas.datacontract.org/2004/07/DenariusCoreBanking.Web.ExternalServices}MEIdentificacionCliente" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "ValidarCondicionesProcesoRapido")
public class ValidarCondicionesProcesoRapido {

    @XmlElementRef(name = "entrada", namespace = "Denarius.CoreBanking.Web.ExternalServices", type = JAXBElement.class, required = false)
    protected JAXBElement<MEIdentificacionCliente> entrada;
     ...
     *     
     */
    public JAXBElement<MEIdentificacionCliente> getEntrada() {
        return entrada;
    }
     ...
     *     
     */
    public void setEntrada(JAXBElement<MEIdentificacionCliente> value) {
        this.entrada = value;
    }

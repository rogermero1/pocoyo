 ...
 *       &lt;sequence&gt;
 *         &lt;element name="meEntrada" type="{http://schemas.datacontract.org/2004/07/DenariusCoreBanking.Web.ExternalServices}MEIdentificacionCliente" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "ValidarAprobacionMalasReferencias")
public class ValidarAprobacionMalasReferencias {

    @XmlElementRef(name = "meEntrada", namespace = "Denarius.CoreBanking.Web.ExternalServices", type = JAXBElement.class, required = false)
    protected JAXBElement<MEIdentificacionCliente> meEntrada;
     ...
     *     
     */
    public JAXBElement<MEIdentificacionCliente> getMeEntrada() {
        return meEntrada;
    }
     ...
     *     
     */
    public void setMeEntrada(JAXBElement<MEIdentificacionCliente> value) {

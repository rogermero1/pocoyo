 ...
 *       &lt;sequence&gt;
 *         &lt;element name="meConsulta" type="{http://schemas.datacontract.org/2004/07/DenariusCoreBanking.Web.ExternalServices.Clientes}MEIdentificacion" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "ConsultarFormulariosOrigenFondosPendientes")
public class ConsultarFormulariosOrigenFondosPendientes {

    @XmlElementRef(name = "meConsulta", namespace = "Denarius.CoreBanking.Web.ExternalServices", type = JAXBElement.class, required = false)
    protected JAXBElement<MEIdentificacion> meConsulta;
     ...
     *     
     */
    public JAXBElement<MEIdentificacion> getMeConsulta() {
        return meConsulta;
    }
     ...
     *     
     */
    public void setMeConsulta(JAXBElement<MEIdentificacion> value) {

 ...
 *       &lt;sequence&gt;
 *         &lt;element name="entrada" type="{http://schemas.datacontract.org/2004/07/DenariusCoreBanking.Web.ExternalServices.Creditos}MECreditos" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "ValidarAprobarCreditoCanales")
public class ValidarAprobarCreditoCanales {

    @XmlElementRef(name = "entrada", namespace = "Denarius.CoreBanking.Web.ExternalServices", type = JAXBElement.class, required = false)
    protected JAXBElement<MECreditos> entrada;
     ...
     *     
     */
    public JAXBElement<MECreditos> getEntrada() {
        return entrada;
    }
     ...
     *     
     */
    public void setEntrada(JAXBElement<MECreditos> value) {
        this.entrada = value;
    }
